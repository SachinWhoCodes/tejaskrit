...
async function loadConfig() {
  ...
  merged.autofill = { ...(DEFAULT_CONFIG.autofill || {}), ...(merged.autofill || {}) };
  // Force backend to production Candidate app.
  merged.backendBaseUrl = DEFAULT_CONFIG.backendBaseUrl;
  state.config = merged;
}

async function saveConfig(patch) {
  state.config = { ...state.config, ...patch, backendBaseUrl: DEFAULT_CONFIG.backendBaseUrl };
